...
/* Exported types ------------------------------------------------------------*/
/* USER CODE BEGIN ET */
	extern QueueHandle_t xCommandQueue; // For START/STOP commands
	extern QueueHandle_t xTimeQueue;    // For time updates
...
/* USER CODE BEGIN EC */
	...
	typedef struct {
	  TimerCommandType_t commandType; // START_TIMER or STOP_TIMER
	  int16_t studyTime;              // Selected study time (minutes)
	  int16_t sessions;               // Selected number of sessions
	} TimerCommand_t;
